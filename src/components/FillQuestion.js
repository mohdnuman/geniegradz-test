  ...
  render() {
    ...
    return (
      <div className="fill-wrapper">
        ...
        {this.props.fill.answered&&this.props.fill.correct&&<span className="correct-text">Correct answer{' '}<img src="https://cdn-icons.flaticon.com/png/512/1634/premium/1634264.png?token=exp=1647771838~hmac=c729804858bcd393f7d651dc3ffbf891" className="tick"/> </span>}
        {this.props.fill.answered&&!this.props.fill.correct&&<span className="wrong-text">Wrong answer{' '}<img src="https://cdn-icons-png.flaticon.com/512/594/594864.png" className="cross"/>  </span>}
