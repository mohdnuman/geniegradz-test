        ...
        {!this.state.started && (
          <div className="popup">
            ...
            <p>
              ...
              1.Close all programs,including email Click on the Click here to open the exam link
              provided in the email from The College.<br/>
              2. Click "Log In For Your Exam Here" at the bottom of the screen. Have your Proctor enter
              the Username and Password provided in the email from The College
              and click enter.<br/>
              3.To begin the exam, click on the link to the
              appropriate exam listed under Online Assessments.<br/>
            </p>
